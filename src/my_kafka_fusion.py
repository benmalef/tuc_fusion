...
def send_status():
    ...
    # producer_fusion_decision = utils.export_fusion_VCD(
    #     final_objects, "producer_message", streams
    # )
    # print("producer", producer_fusion_decision)
    # if flag_send == True:
    # producer_message = utils.producer_message_format(message, fusion_decision)
    ...
    # utils.save(
    #     "/home/benmalef/Desktop/Border_Fusion_Final/tuc_fusion/final_objects.json",
    #     fusion_objects,
    # )
    if count == 5:
